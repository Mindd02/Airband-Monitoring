...
class coba(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "coba")
        ...
        self.freq = freq = 125e6

        ##################################################
        # Blocks
        ##################################################

        self._volume_range = qtgui.Range(0, 100.0, 1, 0.2, 200)
        ...
        self._freq_range = qtgui.Range(118e6, 137e6, 50e3, 125e6, 200)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_am_demod_cf_0, 0), (self.blocks_multiply_const_vxx_0_0_0, 0))
...
def main(top_block_cls=coba, options=None):
